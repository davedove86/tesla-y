...
// update down payment and monthly payment based on current price
const updateDownPaymentBreakdown = () => {
...
const handleWheelButtonClick = (event) => {
  if (event.target.tagName === 'BUTTON') {
    ...
    // add selecetd styles to clicked button
